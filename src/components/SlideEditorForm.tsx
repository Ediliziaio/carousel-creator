...
export function SlideEditorForm({ slide }: Props) {
  ...
  switch (slide.template) {
    case "split":
      body = (
        <SplitEditor d={draft as SplitData} set={set as (d: SplitData) => void} {...editorProps} />
      );
      break;
    case "grid2x2":
      body = (
        <GridEditor
          d={draft as Grid2x2Data}
          set={set as (d: Grid2x2Data) => void}
          {...editorProps}
        />
      );
      break;
    case "bignum":
      body = (
        <BigNumEditor
          d={draft as BigNumData}
          set={set as (d: BigNumData) => void}
          {...editorProps}
        />
      );
      break;
    case "center":
      body = (
        <CenterEditor
          d={draft as CenterData}
          set={set as (d: CenterData) => void}
          {...editorProps}
        />
      );
      break;
    case "timeline":
      body = (
        <TimelineEditor
          d={draft as TimelineData}
          set={set as (d: TimelineData) => void}
          {...editorProps}
        />
      );
      break;
    case "compare":
      body = (
        <CompareEditor
          d={draft as CompareData}
          set={set as (d: CompareData) => void}
          {...editorProps}
        />
      );
      break;
    case "vocab":
      body = (
        <VocabEditor d={draft as VocabData} set={set as (d: VocabData) => void} {...editorProps} />
      );
      break;
    case "qa":
      body = <QAEditor d={draft as QAData} set={set as (d: QAData) => void} {...editorProps} />;
      break;
    case "checklist":
      body = (
        <ChecklistEditor
          d={draft as ChecklistData}
          set={set as (d: ChecklistData) => void}
          {...editorProps}
        />
      );
      break;
    case "stat":
      body = (
        <StatEditor d={draft as StatData} set={set as (d: StatData) => void} {...editorProps} />
      );
      break;
    case "cover":
      body = (
        <CoverEditor d={draft as CoverData} set={set as (d: CoverData) => void} {...editorProps} />
      );
      break;
    case "gallery":
      body = (
        <GalleryEditor
          d={draft as GalleryData}
          set={set as (d: GalleryData) => void}
          {...editorProps}
        />
      );
      break;
    case "imageQuote":
      body = (
        <ImageQuoteEditor
          d={draft as ImageQuoteData}
          set={set as (d: ImageQuoteData) => void}
          {...editorProps}
        />
      );
      break;
    case "chartBar":
      body = (
        <ChartBarEditor
          d={draft as ChartBarData}
          set={set as (d: ChartBarData) => void}
          {...editorProps}
        />
      );
      break;
    case "chartDonut":
      body = (
        <ChartDonutEditor
          d={draft as ChartDonutData}
          set={set as (d: ChartDonutData) => void}
          {...editorProps}
        />
      );
      break;
    case "chartLine":
      body = (
        <ChartLineEditor
          d={draft as ChartLineData}
          set={set as (d: ChartLineData) => void}
          {...editorProps}
        />
      );
      break;
    case "feature":
      body = (
        <FeatureEditor
          d={draft as FeatureData}
          set={set as (d: FeatureData) => void}
          {...editorProps}
        />
      );
      break;
    case "testimonial":
      body = (
        <TestimonialEditor
          d={draft as TestimonialData}
          set={set as (d: TestimonialData) => void}
          {...editorProps}
        />
      );
      break;
    case "myth":
      body = (
        <MythEditor d={draft as MythData} set={set as (d: MythData) => void} {...editorProps} />
      );
      break;
    case "process":
      body = (
        <ProcessEditor
          d={draft as ProcessData}
          set={set as (d: ProcessData) => void}
          {...editorProps}
        />
      );
      break;
    case "prosCons":
      body = (
        <ProsConsEditor
          d={draft as ProsConsData}
          set={set as (d: ProsConsData) => void}
          {...editorProps}
        />
      );
      break;
    case "quoteBig":
      body = (
        <QuoteBigEditor
          d={draft as QuoteBigData}
          set={set as (d: QuoteBigData) => void}
          {...editorProps}
        />
      );
      break;
    case "roadmap":
      body = (
        <RoadmapEditor
          d={draft as RoadmapData}
          set={set as (d: RoadmapData) => void}
          {...editorProps}
        />
      );
      break;
    case "cta":
      body = <CtaEditor d={draft as CtaData} set={set as (d: CtaData) => void} {...editorProps} />;
      break;
    case "hook":
      body = (
        <HookEditor d={draft as HookData} set={set as (d: HookData) => void} {...editorProps} />
      );
      break;
    case "problemSolution":
      body = (
        <ProblemSolutionEditor
          d={draft as ProblemSolutionData}
          set={set as (d: ProblemSolutionData) => void}
          {...editorProps}
        />
      );
      break;
    case "mistakes":
      body = (
        <MistakesEditor
          d={draft as MistakesData}
          set={set as (d: MistakesData) => void}
          {...editorProps}
        />
      );
      break;
    case "framework":
      body = (
        <FrameworkEditor
          d={draft as FrameworkData}
          set={set as (d: FrameworkData) => void}
          {...editorProps}
        />
      );
      break;
    case "socialProof":
      body = (
        <SocialProofEditor
          d={draft as SocialProofData}
          set={set as (d: SocialProofData) => void}
          {...editorProps}
        />
      );
      break;
    case "offer":
      body = (
        <OfferEditor d={draft as OfferData} set={set as (d: OfferData) => void} {...editorProps} />
      );
      break;
    case "objection":
      body = (
        <ObjectionEditor
          d={draft as ObjectionData}
          set={set as (d: ObjectionData) => void}
          {...editorProps}
        />
      );
      break;
    case "tipPack":
      body = (
        <TipPackEditor
          d={draft as TipPackData}
          set={set as (d: TipPackData) => void}
          {...editorProps}
        />
      );
      break;
    case "urgency":
      body = (
        <UrgencyEditor
          d={draft as UrgencyData}
          set={set as (d: UrgencyData) => void}
          {...editorProps}
        />
      );
      break;
    case "bonusStack":
      body = (
        <BonusStackEditor
          d={draft as BonusStackData}
          set={set as (d: BonusStackData) => void}
          {...editorProps}
        />
      );
      break;
    case "guarantee":
      body = (
        <GuaranteeEditor
          d={draft as GuaranteeData}
          set={set as (d: GuaranteeData) => void}
          {...editorProps}
        />
      );
      break;
    case "faq":
      body = <FaqEditor d={draft as FaqData} set={set as (d: FaqData) => void} {...editorProps} />;
      break;
    case "quickWin":
      body = (
        <QuickWinEditor
          d={draft as QuickWinData}
          set={set as (d: QuickWinData) => void}
          {...editorProps}
        />
      );
      break;
    case "mediaHero":
      body = (
        <MediaHeroEditor
          d={draft as MediaHeroData}
          set={set as (d: MediaHeroData) => void}
          {...editorProps}
        />
      );
      break;
    case "polaroidStack":
      body = (
        <PolaroidStackEditor
          d={draft as PolaroidStackData}
          set={set as (d: PolaroidStackData) => void}
          {...editorProps}
        />
      );
      break;
    case "splitDuo":
      body = (
        <SplitDuoEditor
          d={draft as SplitDuoData}
          set={set as (d: SplitDuoData) => void}
          {...editorProps}
        />
      );
      break;
    case "magazineCover":
      body = (
        <MagazineCoverEditor
          d={draft as MagazineCoverData}
          set={set as (d: MagazineCoverData) => void}
          {...editorProps}
        />
      );
      break;
    case "chartArea":
      body = (
        <ChartAreaEditor
          d={draft as ChartAreaData}
          set={set as (d: ChartAreaData) => void}
          {...editorProps}
        />
      );
      break;
    case "chartCompareBar":
      body = (
        <ChartCompareBarEditor
          d={draft as ChartCompareBarData}
          set={set as (d: ChartCompareBarData) => void}
          {...editorProps}
        />
      );
      break;
    case "kpiGrid":
      body = (
        <KpiGridEditor
          d={draft as KpiGridData}
          set={set as (d: KpiGridData) => void}
          {...editorProps}
        />
      );
      break;
    ...
    <div ref={containerRef} className="space-y-4 overflow-x-hidden">
      {languages.length > 1 && (
        <Tabs value={activeLang} onValueChange={setActiveLang}>
          <TabsList
            className="w-full"
            style={{ gridTemplateColumns: `repeat(${languages.length}, 1fr)`, display: "grid" }}
          >
            {languages.map((l) => (
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <Label
          className={`text-xs uppercase tracking-wider ${error ? "text-destructive" : "text-muted-foreground"}`}
        >
          {label}
          {error && " *"}
        </Label>
      ...
      <div
        className={
          error
            ? "[&_input]:border-destructive [&_textarea]:border-destructive [&_input]:focus-visible:ring-destructive [&_textarea]:focus-visible:ring-destructive"
            : ""
        }
      >
        {children}
...
function ItemCounter({
  ...
  const tone = inRange ? "text-emerald-500" : current < min ? "text-amber-500" : "text-destructive";
  return (
  ...
  return (
    <div className="space-y-4">
      ...
      <ImageUploadField
        ...
        hint="Se presente, sostituisce paragrafi/lista a destra."
      />
      <ArrayField
        label="Paragrafi"
        items={d.paragraphs ?? []}
        ...
        render={(v, on, i) => (
          <div className="space-y-1">
            ...
            <div className="grid grid-cols-[80px_1fr] gap-2">
              <Input
                value={v.marker}
                onChange={(e) => on({ ...v, marker: e.target.value })}
                placeholder="01"
              />
              <Input
                value={v.text}
                onChange={(e) => on({ ...v, text: e.target.value })}
                placeholder="Voce"
              />
            </div>
          </div>
    ...
    <div className="space-y-4">
      ...
      {d.cells.map((c, i) => {
        ...
        return (
          <div
            key={i}
            className={`space-y-2 rounded-md border p-3 ${cellErr ? "border-destructive" : "border-border"}`}
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-wrap items-center gap-1">
                <FontSizeSlider
                  compact
                  slideId={slideId!}
                  fieldPath={`cells.${i}.title`}
                  value={overrides?.[`cells.${i}.title`]}
                />
                <TextStylePopover
                  slideId={slideId}
                  fieldPath={`cells.${i}.title`}
                ...
                <FontSizeSlider
                  compact
                  slideId={slideId!}
                  fieldPath={`cells.${i}.text`}
                  value={overrides?.[`cells.${i}.text`]}
                />
                <TextStylePopover
                  slideId={slideId}
                  fieldPath={`cells.${i}.text`}
            ...
            <div className="grid grid-cols-[80px_1fr] gap-2">
              <Input
                ...
                onChange={(e) => {
                  const cells = [...d.cells];
                  cells[i] = { ...c, num: e.target.value };
                  set({ ...d, cells });
                }}
                placeholder="01"
              />
              <Input
                data-field={`cells.${i}.title`}
                value={c.title}
                className={cellErr ? "border-destructive" : ""}
                onChange={(e) => {
                  const cells = [...d.cells];
            ...
            {cellErr && (
              <p className="flex items-center gap-1 text-[11px] text-destructive">
                <AlertCircle className="h-3 w-3" /> {cellErr}
              </p>
            )}
          </div>
        );
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field
          label="Sottotitolo numero"
          slideId={slideId}
          fieldPath="numberSub"
          overrides={overrides}
        >
          <Input value={d.numberSub} onChange={(e) => set({ ...d, numberSub: e.target.value })} />
        </Field>
      </div>
      <Field
        label="Titolo"
...
function CenterEditor({ d, set, errFor, slideId, overrides }: EditorProps<CenterData>) {
  return (
    <div className="space-y-4">
      ...
      <Field label="Sottotitolo" slideId={slideId} fieldPath="sub" overrides={overrides}>
        <Textarea
          rows={2}
          value={d.sub ?? ""}
          onChange={(e) => set({ ...d, sub: e.target.value })}
        />
      </Field>
      <ImageUploadField
        ...
        value={d.imageUrl}
        onChange={(url) => set({ ...d, imageUrl: url })}
        hint="Renderizzata sfocata sotto il testo."
      />
    </div>
  );
}
...
function TimelineEditor({ d, set, errFor, slideId, overrides }: EditorProps<TimelineData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {itemsErr && (
        <p data-field="items" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {itemsErr}
        </p>
      )}
      <ArrayField
        label="Step"
        ...
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2">
              ...
              <Input
                value={v.when}
                onChange={(e) => on({ ...v, when: e.target.value })}
                placeholder="GIORNO 01"
              />
              <Input
                data-field={`items.${i}.title`}
                value={v.title}
                className={itemTitleErr ? "border-destructive" : ""}
                onChange={(e) => on({ ...v, title: e.target.value })}
    ...
    <div className="space-y-4">
      ...
      {(["before", "after"] as const).map((side) => {
        ...
        return (
          <div
            key={side}
            className={`space-y-2 rounded-md border p-3 ${titleErr || itemsErr ? "border-destructive" : "border-border"}`}
          >
            <div className="flex items-center justify-between">
              <div className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                {side === "before" ? "Prima" : "Dopo (in evidenza)"}
              </div>
              <div className="flex items-center gap-1">
                <FontSizeSlider
                  compact
                  slideId={slideId!}
                  fieldPath={`${side}.title`}
                  value={overrides?.[`${side}.title`]}
                />
                <TextStylePopover
                  slideId={slideId}
                  fieldPath={`${side}.title`}
            ...
            <Input
              value={d[side].tag}
              onChange={(e) => set({ ...d, [side]: { ...d[side], tag: e.target.value } })}
              placeholder="TAG"
            />
            <Input
              data-field={`${side}.title`}
              value={d[side].title}
              className={titleErr ? "border-destructive" : ""}
              onChange={(e) => set({ ...d, [side]: { ...d[side], title: e.target.value } })}
            ...
            <ArrayField
              ...
              render={(v, on, i) => {
                ...
                return (
                  <Input
                    data-field={`${side}.items.${i}`}
                    value={v}
                    className={voiceErr ? "border-destructive" : ""}
...
function VocabEditor({ d, set, errFor, slideId, overrides }: EditorProps<VocabData>) {
  return (
    <div className="space-y-4">
      <Field label="Categoria" slideId={slideId} fieldPath="category" overrides={overrides}>
        <Input value={d.category} onChange={(e) => set({ ...d, category: e.target.value })} />
      </Field>
      <Field
        label="Parola"
        error={errFor("word")}
      ...
      >
        <Input
          data-field="word"
          value={d.word}
          onChange={(e) => set({ ...d, word: e.target.value })}
        />
      </Field>
      <Field label="Pronuncia / categoria gramm.">
        <Input value={d.pron} onChange={(e) => set({ ...d, pron: e.target.value })} />
      </Field>
      <Field label="Etichetta definizione">
        <Input value={d.defLabel} onChange={(e) => set({ ...d, defLabel: e.target.value })} />
      </Field>
      <Field
        label="Definizione"
        error={errFor("def")}
      ...
      >
        <Textarea
          ...
          rows={3}
          value={d.def}
          onChange={(e) => set({ ...d, def: e.target.value })}
        />
      </Field>
      <Field
        label="Esempio / citazione"
        slideId={slideId}
        fieldPath="example"
        overrides={overrides}
      >
        <Textarea
          rows={2}
          value={d.example}
          onChange={(e) => set({ ...d, example: e.target.value })}
        />
      </Field>
    </div>
  );
...
function QAEditor({ d, set, errFor, slideId, overrides }: EditorProps<QAData>) {
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Etichetta Q">
          <Input value={d.qLabel} onChange={(e) => set({ ...d, qLabel: e.target.value })} />
        </Field>
        <Field label="Etichetta A">
          <Input value={d.aLabel} onChange={(e) => set({ ...d, aLabel: e.target.value })} />
        </Field>
      </div>
      <Field
        label="Domanda"
      ...
      {answerErr && (
        <p data-field="answer" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {answerErr}
        </p>
      )}
      <ArrayField
        label="Risposta (paragrafi)"
        items={d.answer}
        onChange={(arr) => set({ ...d, answer: arr })}
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-1">
              ...
              <Textarea
                ...
                rows={2}
                value={v}
                className={pErr ? "border-destructive" : ""}
                onChange={(e) => on(e.target.value)}
              />
            </div>
          );
...
function ChecklistEditor({ d, set, errFor, slideId, overrides }: EditorProps<ChecklistData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Field label="Meta (es. '5 PASSI · 10 MIN')">
        <Input value={d.meta} onChange={(e) => set({ ...d, meta: e.target.value })} />
      </Field>
      {itemsErr && (
        <p data-field="items" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {itemsErr}
        ...
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2">
              ...
              <Input
                value={v.note ?? ""}
                onChange={(e) => on({ ...v, note: e.target.value })}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-[1fr_120px] gap-3">
        ...
        <Field label="Unità">
          <Input value={d.unit ?? ""} onChange={(e) => set({ ...d, unit: e.target.value })} />
        </Field>
      </div>
      <Field label="Sottotitolo" slideId={slideId} fieldPath="sub" overrides={overrides}>
        <Textarea
      ...
      <Field label="Nota / fonte">
        <Input value={d.note ?? ""} onChange={(e) => set({ ...d, note: e.target.value })} />
      </Field>
    </div>
  );
}
...
function GalleryEditor({ d, set, errFor, slideId, overrides }: EditorProps<GalleryData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {imgsErr && (
        <p data-field="images" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {imgsErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.images.filter((im) => im.url).length}
        ...
        render={(v, on, i) => (
          <div className="space-y-2 rounded-md border border-border p-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <FontSizeSlider
                  compact
                  slideId={slideId!}
                  fieldPath={`images.${i}.caption`}
                  value={overrides?.[`images.${i}.caption`]}
                />
                <TextStylePopover
                  slideId={slideId}
                  fieldPath={`images.${i}.caption`}
            ...
            <Input
              value={v.caption ?? ""}
              onChange={(e) => on({ ...v, caption: e.target.value })}
    ...
    <div className="space-y-4">
      <div>
        <ImageUploadField
          ...
          value={d.imageUrl}
          onChange={(url) => set({ ...d, imageUrl: url })}
          hint="Renderizzata sotto la citazione."
        />
        {imgErr && (
          <p className="mt-1 flex items-center gap-1 text-[11px] text-destructive">
            <AlertCircle className="h-3 w-3" /> {imgErr}
          </p>
        )}
        {!imgErr && imgWarn && (
          <p className="mt-1 flex items-center gap-1 text-[11px] text-sky-500">
            <Info className="h-3 w-3" /> {imgWarn}
          </p>
        )}
      </div>
      <Field
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <Field label="Ruolo" slideId={slideId} fieldPath="role" overrides={overrides}>
          <Input value={d.role ?? ""} onChange={(e) => set({ ...d, role: e.target.value })} />
        </Field>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.items.length}
            min={LIMITS.chartBar.min}
            max={LIMITS.chartBar.max}
            unit="voci"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`items.${i}.label`}
                    value={overrides?.[`items.${i}.label`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`items.${i}.label`}
              ...
              <div className="grid grid-cols-[1fr_auto] gap-2 sm:grid-cols-[1fr_100px_50px]">
                <Input
                  className={`col-span-2 sm:col-span-1 ${labelErr ? "border-destructive" : ""}`}
                  value={v.label}
                  onChange={(e) => on({ ...v, label: e.target.value })}
                  placeholder="Etichetta"
                />
                <Input
                  type="number"
                  min={0}
                  className={valErr ? "border-destructive" : ""}
                  value={v.value}
                  onChange={(e) => on({ ...v, value: Number(e.target.value) || 0 })}
                  placeholder="0"
                  title="Numero positivo. Es. 42 o 3.5"
                />
                <Input
                  type="color"
                  value={v.color ?? "#00E5FF"}
                  onChange={(e) => on({ ...v, color: e.target.value })}
                  className="h-9 w-full p-1"
                />
              </div>
              {(labelErr || valErr || colorErr) && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {labelErr || valErr || colorErr}
                </p>
              )}
            </div>
          );
...
function ChartDonutEditor({ d, set, errFor, slideId, overrides }: EditorProps<ChartDonutData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Field label="Etichetta al centro (opzionale)">
        <Input
          value={d.centerLabel ?? ""}
          onChange={(e) => set({ ...d, centerLabel: e.target.value })}
        />
      </Field>
      {segsErr && (
        <p data-field="segments" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {segsErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            ...
            min={LIMITS.chartDonut.min}
            max={LIMITS.chartDonut.max}
            unit="segmenti"
          />
        }
        render={(v, on, i) => {
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`segments.${i}.label`}
                    value={overrides?.[`segments.${i}.label`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`segments.${i}.label`}
...
function ChartLineEditor({ d, set, errFor, slideId, overrides }: EditorProps<ChartLineData>) {
  ...
  const addPoint = () =>
    set({ ...d, xLabels: [...d.xLabels, `P${d.xLabels.length + 1}`], values: [...d.values, 0] });
  const removePoint = (i: number) =>
    set({
      ...d,
      xLabels: d.xLabels.filter((_, j) => j !== i),
      values: d.values.filter((_, j) => j !== i),
    });
  return (
    <div className="space-y-4">
      <Field label="Eyebrow" slideId={slideId} fieldPath="eyebrow" overrides={overrides}>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <ItemCounter
            current={d.values.length}
            min={LIMITS.chartLine.min}
            max={LIMITS.chartLine.max}
            unit="punti"
          />
        </div>
        {valuesErr && (
          <p data-field="values" className="flex items-center gap-1 text-[11px] text-destructive">
            <AlertCircle className="h-3 w-3" /> {valuesErr}
          </p>
        )}
        {d.xLabels.map((lb, i) => (
          <div key={i} className="flex flex-col gap-2 sm:flex-row">
            <Input
              className="flex-1"
              value={lb}
              onChange={(e) => updatePoint(i, e.target.value, d.values[i] ?? 0)}
              placeholder="Etichetta X"
            />
            <div className="flex gap-2">
              <Input
                ...
                type="number"
                value={d.values[i] ?? 0}
                onChange={(e) => updatePoint(i, lb, Number(e.target.value) || 0)}
                placeholder="0"
                title="Numero. Es. 42 o 3.5"
              />
        ...
        <Button
          ...
          size="sm"
          disabled={atMax}
          title={atMax ? `Massimo ${LIMITS.chartLine.max} punti` : undefined}
          onClick={addPoint}
        >
...
function FeatureEditor({ d, set, errFor, slideId, overrides }: EditorProps<FeatureData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <ImageUploadField
        label="Immagine spotlight"
        value={d.imageUrl}
        onChange={(url) => set({ ...d, imageUrl: url })}
      />
      {bulletsErr && (
        <p data-field="bullets" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {bulletsErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.bullets.length}
            min={LIMITS.featureBullets.min}
            max={LIMITS.featureBullets.max}
            unit="bullet"
          />
        }
        render={(v, on, i) => {
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`bullets.${i}.title`}
                    value={overrides?.[`bullets.${i}.title`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`bullets.${i}.title`}
  ...
  return (
    <div className="space-y-4">
      <ImageUploadField
        ...
        value={d.avatarUrl}
        onChange={(url) => set({ ...d, avatarUrl: url })}
        variant="avatar"
      />
      <Field
        label="Citazione"
      ...
      <Field label="Rating (0-5, opzionale)" error={errFor("rating")}>
        <Input
          ...
          value={d.rating ?? 0}
          onChange={(e) =>
            set({ ...d, rating: Math.min(5, Math.max(0, Number(e.target.value) || 0)) })
          }
        />
      </Field>
    </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2 rounded-md border border-border p-3">
        ...
        />
        <Field
          label="Testo del mito"
          error={errFor("myth.text")}
          slideId={slideId}
          fieldPath="myth.text"
          overrides={overrides}
        >
      ...
      <div className="space-y-2 rounded-md border border-border p-3">
        ...
        />
        <Field
          label="Testo della realtà"
          error={errFor("reality.text")}
          slideId={slideId}
          fieldPath="reality.text"
          overrides={overrides}
        >
          <Textarea
...
function ProcessEditor({ d, set, errFor, slideId, overrides }: EditorProps<ProcessData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {stepsErr && (
        <p data-field="steps" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {stepsErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.steps.length}
            min={LIMITS.processSteps.min}
            max={LIMITS.processSteps.max}
            unit="step"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`steps.${i}.title`}
                    value={overrides?.[`steps.${i}.title`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`steps.${i}.title`}
              ...
              <div className="grid grid-cols-[80px_1fr] gap-2">
                <Input
                  value={v.number ?? ""}
                  onChange={(e) => on({ ...v, number: e.target.value })}
                  placeholder={`0${i + 1}`}
                />
                <Input
                  data-field={`steps.${i}.title`}
                  className={titleErr ? "border-destructive" : ""}
                  value={v.title}
                  onChange={(e) => on({ ...v, title: e.target.value })}
                  placeholder="Titolo step *"
              ...
              <Textarea
                rows={2}
                value={v.desc}
                onChange={(e) => on({ ...v, desc: e.target.value })}
                placeholder="Descrizione"
              />
              {titleErr && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
...
function ProsConsEditor({ d, set, errFor, slideId, overrides }: EditorProps<ProsConsData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Field label="Etichetta PRO">
          <Input
            value={d.prosLabel ?? "PRO"}
            onChange={(e) => set({ ...d, prosLabel: e.target.value })}
          />
        </Field>
        <Field label="Etichetta CONTRO">
          <Input
            value={d.consLabel ?? "CONTRO"}
            onChange={(e) => set({ ...d, consLabel: e.target.value })}
          />
        </Field>
      </div>
      {prosErr && (
        <p data-field="pros" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {prosErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.pros.length}
            min={LIMITS.prosCons.min}
            max={LIMITS.prosCons.max}
            unit="pro"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <Input
              data-field={`pros.${i}`}
              className={e ? "border-destructive" : ""}
              value={v}
      ...
      />
      {consErr && (
        <p data-field="cons" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {consErr}
        </p>
      )}
      <ArrayField
...
function QuoteBigEditor({ d, set, errFor, slideId, overrides }: EditorProps<QuoteBigData>) {
  return (
    <div className="space-y-4">
      <Field
        label="Citazione"
        hint={`min ${LIMITS.quoteMin}, max ${LIMITS.quoteMax} caratteri`}
        error={errFor("quote")}
        slideId={slideId}
        fieldPath="quote"
        overrides={overrides}
...
function RoadmapEditor({ d, set, errFor, slideId, overrides }: EditorProps<RoadmapData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {msErr && (
        <p data-field="milestones" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {msErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.milestones.length}
            min={LIMITS.roadmap.min}
            max={LIMITS.roadmap.max}
            unit="milestone"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`milestones.${i}.title`}
                    value={overrides?.[`milestones.${i}.title`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`milestones.${i}.title`}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Input
                  data-field={`milestones.${i}.period`}
                  className={periodErr ? "border-destructive" : ""}
                  value={v.period}
                  onChange={(e) => on({ ...v, period: e.target.value })}
                  placeholder="Q1 2026 *"
                />
              </div>
              <Input
                data-field={`milestones.${i}.title`}
                className={titleErr ? "border-destructive" : ""}
                value={v.title}
                onChange={(e) => on({ ...v, title: e.target.value })}
                placeholder="Titolo *"
              ...
              {(titleErr || periodErr) && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {titleErr || periodErr}
                </p>
              )}
            </div>
          );
    ...
    <div className="space-y-4">
      ...
      >
        <Textarea
          rows={2}
          value={d.subtitle ?? ""}
          onChange={(e) => set({ ...d, subtitle: e.target.value })}
        />
      </Field>
      <Field
        label="Etichetta bottone"
        error={errFor("buttonLabel")}
        slideId={slideId}
        fieldPath="buttonLabel"
        overrides={overrides}
      >
        <Input
          data-field="buttonLabel"
          maxLength={LIMITS.buttonMax}
          value={d.buttonLabel}
          onChange={(e) => set({ ...d, buttonLabel: e.target.value })}
          placeholder="SALVA ORA →"
        />
      </Field>
      <Field label="Handle / URL (opzionale)">
        <Input
          value={d.handle ?? ""}
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          ...
          placeholder="LEGGI FINO ALLA FINE"
        />
      </Field>
      <Field
        label="Hook"
        hint={`${LIMITS.hookMin}-${LIMITS.hookMax} caratteri`}
        error={errFor("hook")}
        slideId={slideId}
        fieldPath="hook"
        overrides={overrides}
      ...
      >
        <Input
          value={d.subhook ?? ""}
          onChange={(e) => set({ ...d, subhook: e.target.value })}
          placeholder="E nessuno te lo dice."
        />
      </Field>
      <Field label="Etichetta swipe">
        <Input
          value={d.swipeLabel ?? ""}
          onChange={(e) => set({ ...d, swipeLabel: e.target.value })}
          placeholder="SCORRI →"
        />
      </Field>
    </div>
...
/* ---------------- Problem / Solution ---------------- */
function ProblemSolutionEditor({
  d,
  set,
  errFor,
  slideId,
  overrides,
}: EditorProps<ProblemSolutionData>) {
  return (
    <div className="space-y-4">
      <Field label="Eyebrow" slideId={slideId} fieldPath="eyebrow" overrides={overrides}>
        <Input value={d.eyebrow} onChange={(e) => set({ ...d, eyebrow: e.target.value })} />
      ...
      <div className="space-y-2 rounded-md border border-border p-3">
        ...
        />
        <Field
          label="Testo problema"
          error={errFor("problem.text")}
          slideId={slideId}
          fieldPath="problem.text"
          overrides={overrides}
        >
          <Textarea
      ...
      <div className="space-y-2 rounded-md border border-border p-3">
        ...
        />
        <Field
          label="Testo soluzione"
          error={errFor("solution.text")}
          slideId={slideId}
...
function MistakesEditor({ d, set, errFor, slideId, overrides }: EditorProps<MistakesData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {mErr && (
        <p data-field="mistakes" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {mErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.mistakes.length}
            min={LIMITS.mistakes.min}
            max={LIMITS.mistakes.max}
            unit="errori"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`mistakes.${i}.title`}
                    value={overrides?.[`mistakes.${i}.title`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`mistakes.${i}.title`}
              ...
              <Input
                data-field={`mistakes.${i}.title`}
                className={tErr ? "border-destructive" : ""}
                value={v.title}
                onChange={(e) => on({ ...v, title: e.target.value })}
                placeholder="Titolo errore *"
              />
              <Textarea
                rows={2}
                value={v.why}
                onChange={(e) => on({ ...v, why: e.target.value })}
                placeholder="Perché è un errore"
              />
              {tErr && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {tErr}
                </p>
              )}
            </div>
          );
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          data-field="acronym"
          value={d.acronym}
          onChange={(e) => set({ ...d, acronym: e.target.value })}
          placeholder="AIDA"
        />
      </Field>
      {lErr && (
        <p data-field="letters" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {lErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.letters.length}
            min={LIMITS.frameworkLetters.min}
            max={LIMITS.frameworkLetters.max}
            unit="lettere"
          />
        }
        render={(v, on, i) => {
            ...
            <div className="space-y-2 rounded-md border border-border p-2">
              ...
              <div className="grid grid-cols-[60px_1fr] gap-2">
                <Input
                  ...
                  className={letterErr ? "border-destructive" : ""}
                  value={v.letter}
                  onChange={(e) => on({ ...v, letter: e.target.value })}
                  placeholder="A"
                />
                <Input
                  className={nameErr ? "border-destructive" : ""}
                  value={v.name}
                  onChange={(e) => on({ ...v, name: e.target.value })}
                  placeholder="Nome esteso *"
                />
              </div>
              <Textarea
                rows={2}
              ...
              {(letterErr || nameErr) && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {letterErr || nameErr}
                </p>
              )}
            </div>
          );
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          ...
          value={d.clientName}
          onChange={(e) => set({ ...d, clientName: e.target.value })}
        />
      </Field>
      <Field
        label="Tagline"
      ...
      <ImageUploadField
        ...
        value={d.logoUrl}
        onChange={(url) => set({ ...d, logoUrl: url })}
        variant="avatar"
      />
      ...
      {d.metrics.slice(0, 3).map((m, i) => {
        ...
        return (
          <div key={i} className="space-y-2 rounded-md border border-border p-2">
            ...
            <Input
              className={labErr ? "border-destructive" : ""}
              value={m.label}
              onChange={(e) => {
                const ms = [...d.metrics];
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          ...
          value={d.productName}
          onChange={(e) => set({ ...d, productName: e.target.value })}
        />
      </Field>
      <div className="grid grid-cols-3 gap-2">
        <Field label="Prezzo vecchio">
          <Input
            value={d.priceOld ?? ""}
            onChange={(e) => set({ ...d, priceOld: e.target.value })}
            placeholder="297"
          />
        </Field>
        <Field
          label="Prezzo nuovo *"
          error={errFor("priceNew")}
          slideId={slideId}
          fieldPath="priceNew"
          overrides={overrides}
        >
          <Input
            data-field="priceNew"
            value={d.priceNew}
            onChange={(e) => set({ ...d, priceNew: e.target.value })}
            placeholder="147"
          />
        </Field>
        <Field label="Valuta">
      ...
      {incErr && (
        <p data-field="includes" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {incErr}
        </p>
      )}
      <ArrayField
        ...
        counter={
          <ItemCounter
            current={d.includes.length}
            min={LIMITS.offerIncludes.min}
            max={LIMITS.offerIncludes.max}
            unit="inclusi"
          />
        }
        render={(v, on, i) => {
          ...
          return (
            <Input
              data-field={`includes.${i}`}
              className={e ? "border-destructive" : ""}
              value={v}
              onChange={(ev) => on(ev.target.value)}
              placeholder={`Incluso ${i + 1}`}
            />
          );
        }}
        empty=""
      ...
      >
        <Input
          ...
          maxLength={LIMITS.buttonMax}
          value={d.ctaLabel}
          onChange={(e) => set({ ...d, ctaLabel: e.target.value })}
...
function ObjectionEditor({ d, set, errFor, slideId, overrides }: EditorProps<ObjectionData>) {
  return (
    <div className="space-y-4">
      ...
      <Field
        label="Obiezione"
        hint={`max ${LIMITS.objectionMax} caratteri`}
        error={errFor("objection")}
        slideId={slideId}
        fieldPath="objection"
        overrides={overrides}
      >
        <Textarea
          data-field="objection"
          rows={3}
          maxLength={LIMITS.objectionMax}
          value={d.objection}
          onChange={(e) => set({ ...d, objection: e.target.value })}
        />
      </Field>
      <Field
        label="Risposta"
      ...
      >
        <Textarea
          ...
          maxLength={LIMITS.objectionMax}
          value={d.answer}
          onChange={(e) => set({ ...d, answer: e.target.value })}
        />
      </Field>
      <Field
        label="Chiusura (opzionale)"
        slideId={slideId}
        fieldPath="signOff"
        overrides={overrides}
      >
        <Input
          value={d.signOff ?? ""}
          onChange={(e) => set({ ...d, signOff: e.target.value })}
          placeholder="P.S. provalo gratis"
        />
      </Field>
    </div>
  );
...
function TipPackEditor({ d, set, errFor, slideId, overrides }: EditorProps<TipPackData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {tErr && (
        <p data-field="tips" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {tErr}
        </p>
      )}
      <ArrayField
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FontSizeSlider
                    compact
                    slideId={slideId!}
                    fieldPath={`tips.${i}.title`}
                    value={overrides?.[`tips.${i}.title`]}
                  />
                  <TextStylePopover
                    slideId={slideId}
                    fieldPath={`tips.${i}.title`}
              ...
              <div className="grid grid-cols-[60px_1fr] gap-2">
                <Input
                  value={v.icon ?? ""}
                  onChange={(e) => on({ ...v, icon: e.target.value })}
                  placeholder="⚡"
                />
                <Input
                  data-field={`tips.${i}.title`}
                  className={titleErr ? "border-destructive" : ""}
                  value={v.title}
                  onChange={(e) => on({ ...v, title: e.target.value })}
      ...
      />
      <Field label="Etichetta save">
        <Input
          value={d.saveLabel ?? ""}
          onChange={(e) => set({ ...d, saveLabel: e.target.value })}
          placeholder="SALVA QUESTO POST"
        />
      </Field>
    </div>
  );
...
function UrgencyEditor({ d, set, errFor, slideId, overrides }: EditorProps<UrgencyData>) {
  return (
    <div className="space-y-4">
      ...
      <Field
        label="Countdown (testo)"
        hint="Es. 23:47:12 oppure 'tra 2 giorni'"
        error={errFor("deadline")}
        slideId={slideId}
        fieldPath="deadline"
        overrides={overrides}
      >
        <Input
          data-field="deadline"
          value={d.deadline}
          onChange={(e) => set({ ...d, deadline: e.target.value })}
          placeholder="23:47:12"
        />
      </Field>
      <Field
...
function BonusStackEditor({ d, set, errFor, slideId, overrides }: EditorProps<BonusStackData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {bErr && (
        <p data-field="bonuses" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {bErr}
        </p>
      )}
      <ArrayField
        label="Bonus (1–6)"
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              ...
              <div className="grid grid-cols-[1fr_100px] gap-2">
                ...
                />
                <Input
                  data-field={`bonuses.${i}.value`}
                  className={valErr ? "border-destructive" : ""}
                  value={v.value}
                  onChange={(e) => on({ ...v, value: e.target.value })}
                  placeholder="297"
                />
              </div>
              <Input
                value={v.description ?? ""}
                onChange={(e) => on({ ...v, description: e.target.value })}
                placeholder="Descrizione (opzionale)"
              />
              {(nameErr || valErr) && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {nameErr || valErr}
                </p>
              )}
            </div>
          );
      ...
      <div className="grid grid-cols-3 gap-2">
        <Field label="Valore totale" slideId={slideId} fieldPath="totalValue" overrides={overrides}>
          <Input
            value={d.totalValue}
            onChange={(e) => set({ ...d, totalValue: e.target.value })}
            placeholder="741"
          />
        </Field>
        <Field
          label="Prezzo finale *"
          error={errFor("yourPrice")}
          slideId={slideId}
          fieldPath="yourPrice"
          overrides={overrides}
        >
          <Input
            data-field="yourPrice"
            value={d.yourPrice}
            onChange={(e) => set({ ...d, yourPrice: e.target.value })}
            placeholder="147"
          />
        </Field>
        <Field label="Valuta">
...
function FaqEditor({ d, set, errFor, slideId, overrides }: EditorProps<FaqData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {iErr && (
        <p data-field="items" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {iErr}
        </p>
      )}
      <ArrayField
        label="Domande (2–6)"
        ...
        render={(v, on, i) => {
          ...
          return (
            <div className="space-y-2 rounded-md border border-border p-2">
              ...
              <Input
                data-field={`items.${i}.q`}
                className={qErr ? "border-destructive" : ""}
                value={v.q}
                onChange={(e) => on({ ...v, q: e.target.value })}
                placeholder="Domanda *"
              />
              <Textarea
                data-field={`items.${i}.a`}
                className={aErr ? "border-destructive" : ""}
                rows={2}
                value={v.a}
                onChange={(e) => on({ ...v, a: e.target.value })}
                placeholder="Risposta *"
              />
              {(qErr || aErr) && (
                <p className="flex items-center gap-1 text-[11px] text-destructive">
                  <AlertCircle className="h-3 w-3" /> {qErr || aErr}
                </p>
              )}
            </div>
          );
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          value={d.eyebrow ?? ""}
          onChange={(e) => set({ ...d, eyebrow: e.target.value })}
          placeholder="PROVA SUBITO"
        />
      </Field>
      <Field
        label="Badge tempo (opzionale)"
        slideId={slideId}
        fieldPath="timeBadge"
        overrides={overrides}
      >
        <Input
          value={d.timeBadge ?? ""}
          onChange={(e) => set({ ...d, timeBadge: e.target.value })}
          placeholder="60 sec"
        />
      </Field>
      <Field
      ...
      >
        <Textarea
          ...
          rows={2}
          value={d.instruction}
          onChange={(e) => set({ ...d, instruction: e.target.value })}
          placeholder="Cambia la bio di Instagram in 60 secondi."
        />
      </Field>
      {sErr && (
        <p data-field="steps" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {sErr}
        </p>
      )}
      <ArrayField
        label="Step (1–5)"
      ...
      />
      <Field
        label="Risultato atteso (opzionale)"
        slideId={slideId}
      ...
      >
        <Input
          ...
          onChange={(e) => set({ ...d, expectedResult: e.target.value })}
          placeholder="+30% di click sul link in bio"
        />
      </Field>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      <ImageUploadField
        ...
        value={d.imageUrl}
        onChange={(url) => set({ ...d, imageUrl: url })}
        hint="Foto verticale ad alta risoluzione per massimo impatto."
      />
      <Field label="Eyebrow" slideId={slideId} fieldPath="eyebrow" overrides={overrides}>
        <Input
          value={d.eyebrow ?? ""}
        ...
        <div className="flex gap-2">
          {(["soft", "strong"] as const).map((v) => (
            <Button
              ...
              type="button"
              size="sm"
              variant={d.overlayIntensity === v ? "default" : "outline"}
              onClick={() => set({ ...d, overlayIntensity: v })}
            >
              {v === "soft" ? "Soft" : "Strong"}
            </Button>
          ))}
...
function PolaroidStackEditor({
  d,
  set,
  errFor,
  slideId,
  overrides,
}: EditorProps<PolaroidStackData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {pErr && (
        <p data-field="polaroids" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {pErr}
        </p>
      )}
      <ArrayField
        label="Polaroid (1–3)"
        ...
        render={(v, on, i) => (
          <div className="space-y-2 rounded-md border border-border p-2">
            ...
            <Input
              value={v.date ?? ""}
              onChange={(e) => on({ ...v, date: e.target.value })}
              placeholder="Mag 2025"
            />
          </div>
        )}
...
function SplitDuoEditor({ d, set, errFor, slideId, overrides }: EditorProps<SplitDuoData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2 rounded-md border border-border p-3">
          ...
          <ImageUploadField
            label=""
            value={left.url}
            onChange={(url) => set({ ...d, leftImage: { ...left, url } })}
          />
          <Field
            label="Etichetta"
            error={errFor("leftImage.label")}
            slideId={slideId}
            fieldPath="leftImage.label"
            overrides={overrides}
          >
            <Input
              data-field="leftImage.label"
              value={left.label}
              onChange={(e) => set({ ...d, leftImage: { ...left, label: e.target.value } })}
              placeholder="PRIMA"
            />
          </Field>
        </div>
        <div className="space-y-2 rounded-md border border-border p-3">
          ...
          <ImageUploadField
            label=""
            value={right.url}
            onChange={(url) => set({ ...d, rightImage: { ...right, url } })}
          />
          <Field
            label="Etichetta"
            error={errFor("rightImage.label")}
            slideId={slideId}
            fieldPath="rightImage.label"
            overrides={overrides}
          >
            <Input
              data-field="rightImage.label"
              value={right.label}
              onChange={(e) => set({ ...d, rightImage: { ...right, label: e.target.value } })}
              placeholder="DOPO"
            />
          </Field>
        </div>
      ...
      <Field
        label="Badge centrale"
        error={errFor("centerBadge")}
        slideId={slideId}
        fieldPath="centerBadge"
        overrides={overrides}
      >
        <Input
          data-field="centerBadge"
          value={d.centerBadge ?? ""}
          onChange={(e) => set({ ...d, centerBadge: e.target.value })}
          placeholder="VS"
        />
      </Field>
      <Field
        label="Caption (opzionale)"
        slideId={slideId}
        fieldPath="caption"
        overrides={overrides}
      >
...
function MagazineCoverEditor({
  d,
  set,
  errFor,
  slideId,
  overrides,
}: EditorProps<MagazineCoverData>) {
    ...
    <div className="space-y-4">
      ...
      >
        <Input
          data-field="masthead"
          value={d.masthead ?? ""}
          onChange={(e) => set({ ...d, masthead: e.target.value })}
          placeholder="VOGUE"
        />
      </Field>
      <Field label="Numero / Data" slideId={slideId} fieldPath="issueLabel" overrides={overrides}>
        <Input
          value={d.issueLabel ?? ""}
          onChange={(e) => set({ ...d, issueLabel: e.target.value })}
          placeholder="N° 12 · Nov 2025"
        />
      </Field>
      <ImageUploadField
        label="Foto centrale"
      ...
      />
      <Field
        label="Headline principale"
        hint={HL_HINT}
        error={errFor("mainHeadline")}
        slideId={slideId}
        fieldPath="mainHeadline"
        overrides={overrides}
      >
        <Textarea
          data-field="mainHeadline"
          rows={2}
          value={d.mainHeadline ?? ""}
          onChange={(e) => set({ ...d, mainHeadline: e.target.value })}
        />
      </Field>
      {cErr && (
        <p data-field="coverLines" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {cErr}
        </p>
      )}
      <ArrayField
        ...
        render={(v, on, i) => (
          <div className="grid grid-cols-[1fr_90px] gap-2">
            <Input
              value={v.text}
              onChange={(e) => on({ ...v, text: e.target.value })}
              placeholder={`Strillo ${i + 1}`}
            />
            <Input
              value={v.pageRef ?? ""}
              onChange={(e) => on({ ...v, pageRef: e.target.value })}
              placeholder="p. 12"
            />
          </div>
        )}
  ...
  return (
    <div className="space-y-4">
          ...
          <div className="flex gap-2">
            {(["up", "down"] as const).map((t) => (
              <Button
                ...
                type="button"
                size="sm"
                variant={d.trend === t ? "default" : "outline"}
                onClick={() => set({ ...d, trend: t })}
              >
                {t === "up" ? "▲ Up" : "▼ Down"}
              </Button>
            ))}
      ...
      <Field label="Etichetta picco" slideId={slideId} fieldPath="peakLabel" overrides={overrides}>
        <Input
          value={d.peakLabel ?? ""}
          onChange={(e) => set({ ...d, peakLabel: e.target.value })}
          placeholder="Picco virale"
        />
      </Field>
      {vErr && (
        <p data-field="values" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {vErr}
        </p>
      )}
      <ArrayField
        label="Punti (3–24)"
        ...
        render={(v, on, i) => (
          <div className="grid grid-cols-[1fr_100px] gap-2">
            <Input
              value={v.x}
              onChange={(e) => {
                on({ ...v, x: e.target.value });
                updatePair(i, e.target.value);
              }}
              placeholder="Etichetta X"
            />
            <Input
...
function ChartCompareBarEditor({
  d,
  set,
  errFor,
  slideId,
  overrides,
}: EditorProps<ChartCompareBarData>) {
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Field label="Serie A — label" error={errFor("seriesA.label")}>
          <Input
            data-field="seriesA.label"
            value={seriesA.label}
            onChange={(e) => set({ ...d, seriesA: { ...seriesA, label: e.target.value } })}
          />
        </Field>
        <Field label="Serie A — colore (#hex)" error={errFor("seriesA.color")}>
          <Input
            value={seriesA.color ?? ""}
            onChange={(e) =>
              set({ ...d, seriesA: { ...seriesA, color: e.target.value || undefined } })
            }
            placeholder="#00E5FF"
          />
        </Field>
        <Field label="Serie B — label" error={errFor("seriesB.label")}>
          <Input
            data-field="seriesB.label"
            value={seriesB.label}
            onChange={(e) => set({ ...d, seriesB: { ...seriesB, label: e.target.value } })}
          />
        </Field>
        <Field label="Serie B — colore (#hex)" error={errFor("seriesB.color")}>
          <Input
            value={seriesB.color ?? ""}
            onChange={(e) =>
              set({ ...d, seriesB: { ...seriesB, color: e.target.value || undefined } })
            }
            placeholder="#B24BF3"
          />
        </Field>
      ...
      {rErr && (
        <p data-field="rows" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {rErr}
        </p>
      )}
      <ArrayField
        label="Righe (2–6)"
          ...
          return (
            <div className="space-y-1 rounded-md border border-border p-2">
              <Input
                ...
                className={lErr ? "border-destructive" : ""}
                value={v.label}
                onChange={(e) => on({ ...v, label: e.target.value })}
              ...
              <div className="grid grid-cols-2 gap-2">
                <Input
                  type="number"
                  value={v.valueA}
                  onChange={(e) => on({ ...v, valueA: Number(e.target.value) })}
                  placeholder="A"
                />
                <Input
                  type="number"
                  value={v.valueB}
                  onChange={(e) => on({ ...v, valueB: Number(e.target.value) })}
                  placeholder="B"
                />
              </div>
            </div>
...
function KpiGridEditor({ d, set, errFor, slideId, overrides }: EditorProps<KpiGridData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {kErr && (
        <p data-field="kpis" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {kErr}
        </p>
      )}
      <Label className="text-xs uppercase tracking-wider text-muted-foreground">
        4 KPI (esattamente)
...
function FunnelChartEditor({ d, set, errFor, slideId, overrides }: EditorProps<FunnelChartData>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {sErr && (
        <p data-field="stages" className="flex items-center gap-1 text-[11px] text-destructive">
          <AlertCircle className="h-3 w-3" /> {sErr}
        </p>
      )}
      <ArrayField
          ...
          return (
            <div className="space-y-1 rounded-md border border-border p-2">
              <Input
                ...
                value={v.label}
                onChange={(e) => on({ ...v, label: e.target.value })}
                placeholder={`Stadio ${i + 1} *`}
              />
              <div className="grid grid-cols-[1fr_120px] gap-2">
                <Input
                  data-field={`stages.${i}.value`}
                  className={vErr ? "border-destructive" : ""}
                  value={v.value}
                  onChange={(e) => on({ ...v, value: e.target.value })}
                  placeholder="Valore *"
                />
                <Input
                  value={v.conversionPercent ?? ""}
                  onChange={(e) => on({ ...v, conversionPercent: e.target.value })}
                  placeholder="12%"
                />
              </div>
            </div>
